...
MODELS_JSON=$(START_SCRIPT="$START_SCRIPT" MODELS_DIR="$MODELS_DIR" OPENCODE_OUTPUT_LIMIT="$OPENCODE_OUTPUT_LIMIT" python3 -c "
...
echo "OpenCode limits: context from start-i9.sh${IK_LLAMA_CTX_SIZE:+ overridden by IK_LLAMA_CTX_SIZE=$IK_LLAMA_CTX_SIZE}, output=$OPENCODE_OUTPUT_LIMIT, compaction reserved=$OPENCODE_COMPACTION_RESERVED"
